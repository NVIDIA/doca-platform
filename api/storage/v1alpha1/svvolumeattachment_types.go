...
// NOTE: A separate type for the svvolumeattachment CR is maintained within the nvidia-external-attacher tree.
// If you modify this CR, please ensure you update it there as well.
