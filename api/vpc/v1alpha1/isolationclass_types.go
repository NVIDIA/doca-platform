...
const (
	...
	// ProvisionerNameLabel is the name of the label that can be used to mark
	// that the object should be handled by specified provisioner
	ProvisionerNameLabel = "vpc.dpu.nvidia.com/provisioner"
)
...
// +kubebuilder:validation:XValidation:rule="self.provisioner == oldSelf.provisioner",message="IsolationClass spec.provisioner is immutable"
