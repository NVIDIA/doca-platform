...
const (
	// ConditionTopologyReconciled is a condition that is set when the network topology for the DPUVPC is reconciled.
	ConditionTopologyReconciled conditions.ConditionType = "TopologyReconciled"
	// ConditionDPUVPCReconciled is a condition that is set when the DPUVPC is reconciled.
	ConditionDPUVPCReconciled conditions.ConditionType = "DPUVPCReconciled"
	// ConditionDPUNodesReconciled is a condition that is set when the DPU nodes are reconciled.
	ConditionDPUNodesReconciled conditions.ConditionType = "DPUNodesReconciled"
)
...
var (
	...
	DPUVPCConditions = []conditions.ConditionType{
		...
		ConditionDPUVPCReconciled,
		ConditionDPUNodesReconciled,
		ConditionTopologyReconciled,
...
// +kubebuilder:validation:XValidation:rule="(!has(self.nodeSelector) && !has(oldSelf.nodeSelector)) || (has(self.nodeSelector) && has(oldSelf.nodeSelector) && self.nodeSelector == oldSelf.nodeSelector)",message="nodeSelector is immutable"
// +kubebuilder:validation:XValidation:rule="self.isolationClassName == oldSelf.isolationClassName",message="isolationClassName is immutable"
...
// +kubebuilder:selectablefield:JSONPath=`.spec.isolationClassName`
