...
func (x *GetDeviceRequest) Reset() {
	*x = GetDeviceRequest{}
	mi := &file_nvidia_storage_plugins_v1_storage_plugin_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetDeviceRequest) Descriptor() ([]byte, []int) {
	return file_nvidia_storage_plugins_v1_storage_plugin_proto_rawDescGZIP(), []int{13}
}

func (x *GetDeviceRequest) GetVolumeId() string {
	if x != nil {
		return x.VolumeId
	}
	return ""
...
type GetDeviceResponse struct {
	...
	AccessModes []AccessMode `protobuf:"varint,1,rep,packed,name=access_modes,json=accessModes,proto3,enum=nvidia.storage.plugins.v1.AccessMode" json:"access_modes,omitempty"`
	// Indicates the volume mode. Either Filesystem or Block. Default value is Filesystem. This field is OPTIONAL
	VolumeMode string `protobuf:"bytes,2,opt,name=volume_mode,json=volumeMode,proto3" json:"volume_mode,omitempty"`
	...
	StorageParameters map[string]string `protobuf:"bytes,5,rep,name=storage_parameters,json=storageParameters,proto3" json:"storage_parameters,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (*GetDeviceResponse) Descriptor() ([]byte, []int) {
	return file_nvidia_storage_plugins_v1_storage_plugin_proto_rawDescGZIP(), []int{14}
}

func (x *GetDeviceResponse) GetAccessModes() []AccessMode {
	if x != nil {
		return x.AccessModes
	}
	return nil
...
func (x *GetDeviceResponse) GetVolumeMode() string {
	if x != nil {
		return x.VolumeMode
	}
	return ""
...
func (x *GetDeviceResponse) GetPublishContext() map[string]string {
	if x != nil {
		return x.PublishContext
	}
	return nil
...
func (x *GetDeviceResponse) GetVolumeContext() map[string]string {
	if x != nil {
		return x.VolumeContext
	}
	return nil
...
func (x *GetDeviceResponse) GetStorageParameters() map[string]string {
	if x != nil {
		return x.StorageParameters
	}
	return nil
...
func (x *ListDevicesRequest) Reset() {
	*x = ListDevicesRequest{}
	mi := &file_nvidia_storage_plugins_v1_storage_plugin_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListDevicesRequest) Descriptor() ([]byte, []int) {
	return file_nvidia_storage_plugins_v1_storage_plugin_proto_rawDescGZIP(), []int{15}
}

func (x *ListDevicesRequest) GetMaxEntries() int32 {
	if x != nil {
		return x.MaxEntries
	}
	return 0
...
func (x *ListDevicesRequest) GetStartingToken() string {
	if x != nil {
...
type ListDevicesResponse struct {
	...
	Entries []*ListDevicesResponse_Entry `protobuf:"bytes,1,rep,name=entries,proto3" json:"entries,omitempty"`
...
func (x *ListDevicesResponse) Reset() {
	*x = ListDevicesResponse{}
	mi := &file_nvidia_storage_plugins_v1_storage_plugin_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListDevicesResponse) Descriptor() ([]byte, []int) {
	return file_nvidia_storage_plugins_v1_storage_plugin_proto_rawDescGZIP(), []int{16}
}

func (x *ListDevicesResponse) GetEntries() []*ListDevicesResponse_Entry {
	if x != nil {
		return x.Entries
	}
	return nil
...
func (x *ListDevicesResponse) GetNextToken() string {
	if x != nil {
		return x.NextToken
	}
	return ""
...
func (x *StoragePluginServiceCapability_RPC) Reset() {
	*x = StoragePluginServiceCapability_RPC{}
	mi := &file_nvidia_storage_plugins_v1_storage_plugin_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type ListDevicesResponse_Entry struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ListDevicesResponse_Entry) Reset() {
	*x = ListDevicesResponse_Entry{}
	mi := &file_nvidia_storage_plugins_v1_storage_plugin_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListDevicesResponse_Entry) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListDevicesResponse_Entry) ProtoMessage() {}

func (x *ListDevicesResponse_Entry) ProtoReflect() protoreflect.Message {
	mi := &file_nvidia_storage_plugins_v1_storage_plugin_proto_msgTypes[25]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListDevicesResponse_Entry.ProtoReflect.Descriptor instead.
func (*ListDevicesResponse_Entry) Descriptor() ([]byte, []int) {
	return file_nvidia_storage_plugins_v1_storage_plugin_proto_rawDescGZIP(), []int{16, 0}
}

func (x *ListDevicesResponse_Entry) GetVolumeId() string {
	if x != nil {
		return x.VolumeId
	}
	return ""
...
func (x *ListDevicesResponse_Entry) GetDeviceName() string {
	if x != nil {
		return x.DeviceName
	}
	return ""
...
var file_nvidia_storage_plugins_v1_storage_plugin_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x50, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x52, 0x65,
	...
	,
	...
	0x66, 0x0a, 0x0e, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78,
	0x74, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3f, 0x2e, 0x6e, 0x76, 0x69, 0x64, 0x69, 0x61,
	...
	,
	...
	0x1a, 0x44, 0x0a, 0x16, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d,
	0x65, 0x74, 0x65, 0x72, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65,
	0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05,
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x5c, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x65,
	...
	0x05, 0x52, 0x0a, 0x6d, 0x61, 0x78, 0x45, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x12, 0x25, 0x0a,
	0x0e, 0x73, 0x74, 0x61, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x73, 0x74, 0x61, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x54,
	0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xcb, 0x01, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x65, 0x76,
	...
	0x6e, 0x76, 0x69, 0x64, 0x69, 0x61, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x70,
	0x6c, 0x75, 0x67, 0x69, 0x6e, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x65,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x45, 0x6e,
	...
	0x52, 0x09, 0x6e, 0x65, 0x78, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x1a, 0x45, 0x0a, 0x05, 0x45,
	0x6e, 0x74, 0x72, 0x79, 0x12, 0x1b, 0x0a, 0x09, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x5f, 0x69,
	...
	,
...
var file_nvidia_storage_plugins_v1_storage_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_nvidia_storage_plugins_v1_storage_plugin_proto_goTypes = []any{
	...
	(*GetDeviceRequest)(nil),                     // 15: nvidia.storage.plugins.v1.GetDeviceRequest
	(*GetDeviceResponse)(nil),                    // 16: nvidia.storage.plugins.v1.GetDeviceResponse
	(*ListDevicesRequest)(nil),                   // 17: nvidia.storage.plugins.v1.ListDevicesRequest
	(*ListDevicesResponse)(nil),                  // 18: nvidia.storage.plugins.v1.ListDevicesResponse
	nil,                                          // 19: nvidia.storage.plugins.v1.GetPluginInfoResponse.ManifestEntry
	(*StoragePluginServiceCapability_RPC)(nil),   // 20: nvidia.storage.plugins.v1.StoragePluginServiceCapability.RPC
	nil,                               // 21: nvidia.storage.plugins.v1.CreateDeviceRequest.PublishContextEntry
	nil,                               // 22: nvidia.storage.plugins.v1.CreateDeviceRequest.VolumeContextEntry
	nil,                               // 23: nvidia.storage.plugins.v1.CreateDeviceRequest.StorageParametersEntry
	nil,                               // 24: nvidia.storage.plugins.v1.GetDeviceResponse.PublishContextEntry
	nil,                               // 25: nvidia.storage.plugins.v1.GetDeviceResponse.VolumeContextEntry
	nil,                               // 26: nvidia.storage.plugins.v1.GetDeviceResponse.StorageParametersEntry
	(*ListDevicesResponse_Entry)(nil), // 27: nvidia.storage.plugins.v1.ListDevicesResponse.Entry
...
var file_nvidia_storage_plugins_v1_storage_plugin_proto_depIdxs = []int32{
	19, // 0: nvidia.storage.plugins.v1.GetPluginInfoResponse.manifest:type_name -> nvidia.storage.plugins.v1.GetPluginInfoResponse.ManifestEntry
	28, // 1: nvidia.storage.plugins.v1.ProbeResponse.ready:type_name -> google.protobuf.BoolValue
	...
	20, // 3: nvidia.storage.plugins.v1.StoragePluginServiceCapability.rpc:type_name -> nvidia.storage.plugins.v1.StoragePluginServiceCapability.RPC
	0,  // 4: nvidia.storage.plugins.v1.CreateDeviceRequest.access_modes:type_name -> nvidia.storage.plugins.v1.AccessMode
	21, // 5: nvidia.storage.plugins.v1.CreateDeviceRequest.publish_context:type_name -> nvidia.storage.plugins.v1.CreateDeviceRequest.PublishContextEntry
	22, // 6: nvidia.storage.plugins.v1.CreateDeviceRequest.volume_context:type_name -> nvidia.storage.plugins.v1.CreateDeviceRequest.VolumeContextEntry
	23, // 7: nvidia.storage.plugins.v1.CreateDeviceRequest.storage_parameters:type_name -> nvidia.storage.plugins.v1.CreateDeviceRequest.StorageParametersEntry
	0,  // 8: nvidia.storage.plugins.v1.GetDeviceResponse.access_modes:type_name -> nvidia.storage.plugins.v1.AccessMode
	24, // 9: nvidia.storage.plugins.v1.GetDeviceResponse.publish_context:type_name -> nvidia.storage.plugins.v1.GetDeviceResponse.PublishContextEntry
	25, // 10: nvidia.storage.plugins.v1.GetDeviceResponse.volume_context:type_name -> nvidia.storage.plugins.v1.GetDeviceResponse.VolumeContextEntry
	26, // 11: nvidia.storage.plugins.v1.GetDeviceResponse.storage_parameters:type_name -> nvidia.storage.plugins.v1.GetDeviceResponse.StorageParametersEntry
	27, // 12: nvidia.storage.plugins.v1.ListDevicesResponse.entries:type_name -> nvidia.storage.plugins.v1.ListDevicesResponse.Entry
	1,  // 13: nvidia.storage.plugins.v1.StoragePluginServiceCapability.RPC.type:type_name -> nvidia.storage.plugins.v1.StoragePluginServiceCapability.RPC.Type
	2,  // 14: nvidia.storage.plugins.v1.IdentityService.GetPluginInfo:input_type -> nvidia.storage.plugins.v1.GetPluginInfoRequest
	4,  // 15: nvidia.storage.plugins.v1.IdentityService.Probe:input_type -> nvidia.storage.plugins.v1.ProbeRequest
	6,  // 16: nvidia.storage.plugins.v1.StoragePluginService.StoragePluginGetCapabilities:input_type -> nvidia.storage.plugins.v1.StoragePluginGetCapabilitiesRequest
	9,  // 17: nvidia.storage.plugins.v1.StoragePluginService.GetSNAPProvider:input_type -> nvidia.storage.plugins.v1.GetSNAPProviderRequest
	11, // 18: nvidia.storage.plugins.v1.StoragePluginService.CreateDevice:input_type -> nvidia.storage.plugins.v1.CreateDeviceRequest
	13, // 19: nvidia.storage.plugins.v1.StoragePluginService.DeleteDevice:input_type -> nvidia.storage.plugins.v1.DeleteDeviceRequest
	15, // 20: nvidia.storage.plugins.v1.StoragePluginService.GetDevice:input_type -> nvidia.storage.plugins.v1.GetDeviceRequest
	17, // 21: nvidia.storage.plugins.v1.StoragePluginService.ListDevices:input_type -> nvidia.storage.plugins.v1.ListDevicesRequest
	3,  // 22: nvidia.storage.plugins.v1.IdentityService.GetPluginInfo:output_type -> nvidia.storage.plugins.v1.GetPluginInfoResponse
	5,  // 23: nvidia.storage.plugins.v1.IdentityService.Probe:output_type -> nvidia.storage.plugins.v1.ProbeResponse
	7,  // 24: nvidia.storage.plugins.v1.StoragePluginService.StoragePluginGetCapabilities:output_type -> nvidia.storage.plugins.v1.StoragePluginGetCapabilitiesResponse
	10, // 25: nvidia.storage.plugins.v1.StoragePluginService.GetSNAPProvider:output_type -> nvidia.storage.plugins.v1.GetSNAPProviderResponse
	12, // 26: nvidia.storage.plugins.v1.StoragePluginService.CreateDevice:output_type -> nvidia.storage.plugins.v1.CreateDeviceResponse
	14, // 27: nvidia.storage.plugins.v1.StoragePluginService.DeleteDevice:output_type -> nvidia.storage.plugins.v1.DeleteDeviceResponse
	16, // 28: nvidia.storage.plugins.v1.StoragePluginService.GetDevice:output_type -> nvidia.storage.plugins.v1.GetDeviceResponse
	18, // 29: nvidia.storage.plugins.v1.StoragePluginService.ListDevices:output_type -> nvidia.storage.plugins.v1.ListDevicesResponse
