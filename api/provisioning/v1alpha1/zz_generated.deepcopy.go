...
func (in *DPUFlavorSpec) DeepCopyInto(out *DPUFlavorSpec) {
	*out = *in
	...
	if in.P0NetworkInterfaceConfig != nil {
		in, out := &in.P0NetworkInterfaceConfig, &out.P0NetworkInterfaceConfig
		*out = new(NetworkInterfaceConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.P1NetworkInterfaceConfig != nil {
		in, out := &in.P1NetworkInterfaceConfig, &out.P1NetworkInterfaceConfig
		*out = new(NetworkInterfaceConfig)
		(*in).DeepCopyInto(*out)
	}
}
