...
func (in *BlueFieldSpec) DeepCopyInto(out *BlueFieldSpec) {
	*out = *in
	out.TmpFwComponents = in.TmpFwComponents
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DPUInfo) DeepCopyInto(out *DPUInfo) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DPUInfo.
func (in *DPUInfo) DeepCopy() *DPUInfo {
	if in == nil {
		return nil
	}
	out := new(DPUInfo)
