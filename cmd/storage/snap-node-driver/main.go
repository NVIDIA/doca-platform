...
import (
	...
	snap "github.com/nvidia/doca-platform/internal/storage/snap/node-driver"
...
func main() {
	...
	nodeName := os.Getenv("SNAP_NODE_DRIVER_NODE_NAME")
	if nodeName == "" {
		setupLog.Error(nil, "SNAP_NODE_DRIVER_NODE_NAME environment variable must be set")
	}
	...
	if err = (&snap.VolumeAttachmentReconciler{
	...
	setupLog.Info("starting SNAP Node Driver")
