...
func main() {
	...
	pflag.BoolVar(&options.SkipVFConfig, "skip-vf-config", false, "Skip VF configuration")
	...
	pflag.BoolVar(&options.SkipCleanPluginRegistry, "skip-clean-plugin-registry", false, "Skip cleaning stale kubelet device-plugin registration sockets")
