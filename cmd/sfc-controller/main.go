...
func main() {
	...
	options = append(options, client.WithLogger(&discardLogger))
	...
	if secureFlowDeletionTimeout > 0 {
		setupLog.Info("SecureConnection feature is enabled", "timeout", secureFlowDeletionTimeout)
