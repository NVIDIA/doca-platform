---
title: "DOCA Platform Framework v24.10.0"
---
...
Refer to [Prerequisites](../user-guides/prerequisites/prerequisites.md) for detailed requirements.
...
10. **Title:** Stale ports after DPU reboot  
   ...
   **Workaround:**  
     No workaround, known issue, shouldn’t affect performance.
...
17. **Title:** DPU object in pending phase without clear reason  
   **Description:**  
     DPU object wait in pending phase in case the BFB Object it references doesn't exist or none of the BFB objects are in Ready phase, this is the required behavior but doesn't have clear indication on DPU object.  
