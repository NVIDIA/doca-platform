...
* **Title:** MTU minimum value changes
  **Description:**  
    The minimum MTU value has been increased from 1000 to 1280 bytes across multiple API fields. Additionally, maximum MTU constraints have been added where applicable.
  **Affected Fields:**
  ...
  **Impact:**  
    Existing resources with MTU values below 1280 will need to be updated. The system will reject values below the new minimum during validation.
