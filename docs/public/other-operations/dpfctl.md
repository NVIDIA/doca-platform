...
├─DPUServices
│ └─11 DPUServices...                    dpf-operator-system  True   Success            27h    See doca-blueman-service, doca-hbn, doca-telemetry-service, flannel, multus, nvidia-k8s-ipam,
│                                                                                              ovn-dpu, ovs-cni, servicechainset-controller, sfc-controller, sriov-device-plugin
└─DPUSets
