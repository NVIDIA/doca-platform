...
If your platform uses a bridge name other than `br-dpu` for out-of-band management, set
`spec.networking.dpuNodeOOBBridgeName` in `DPFOperatorConfig` before starting the host agent. The bridge must already
