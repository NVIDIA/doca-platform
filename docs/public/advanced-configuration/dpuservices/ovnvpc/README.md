...
For the full API definition, refer to [DPF API Documentation](../../../developer-guides/api/api.md).
...
<details markdown="1"><summary><b>Reference Example</b></summary>
...
Please follow the [OVN VPC deployment guide](../../../user-guides/zero-trust/use-cases/vpc/README.md) to deploy the OVN VPC Service.
...
<details markdown="1"><summary><b>VPC Example Topology</b></summary>
