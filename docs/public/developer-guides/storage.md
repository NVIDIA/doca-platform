...
* [Trusted Kubernetes cluster on host](#trusted-kubernetes-cluster-on-host)
* [Non-trusted host](#non-trusted-host)

The set of deployed components, available features, and APIs is different in each scenario.

### Trusted Kubernetes cluster on host
...
#### End-to-End Flow Description for Non-trusted host scenario

The following steps outline the end-to-end process for provisioning and attaching storage using the DPF storage subsystem in the Non-trusted host scenario:
