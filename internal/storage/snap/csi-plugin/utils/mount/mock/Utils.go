...
// EnsureDirExist mocks base method.
func (m *MockUtils) EnsureDirExist(dirPath string, mode os.FileMode) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EnsureDirExist", dirPath, mode)
	ret0, _ := ret[0].(error)
	return ret0
}

// EnsureDirExist indicates an expected call of EnsureDirExist.
func (mr *MockUtilsMockRecorder) EnsureDirExist(dirPath, mode any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EnsureDirExist", reflect.TypeOf((*MockUtils)(nil).EnsureDirExist), dirPath, mode)
}
