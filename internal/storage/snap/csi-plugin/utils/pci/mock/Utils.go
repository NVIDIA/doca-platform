...
import (
	...
	pci "github.com/nvidia/doca-platform/internal/storage/snap/csi-plugin/utils/pci"
...
// IsSRIOVEnabled mocks base method.
func (m *MockUtils) IsSRIOVEnabled(pciAddress string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsSRIOVEnabled", pciAddress)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// IsSRIOVEnabled indicates an expected call of IsSRIOVEnabled.
func (mr *MockUtilsMockRecorder) IsSRIOVEnabled(pciAddress any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsSRIOVEnabled", reflect.TypeOf((*MockUtils)(nil).IsSRIOVEnabled), pciAddress)
}
