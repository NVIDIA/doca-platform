...
func New(commonConfig config.Common, nodeConfig config.Node, runtimeCfg *config.NodeRuntime, mount utilsMount.Utils, nvme utilsNvme.Utils, pci utilsPci.Utils) Handler {
	return &node{
