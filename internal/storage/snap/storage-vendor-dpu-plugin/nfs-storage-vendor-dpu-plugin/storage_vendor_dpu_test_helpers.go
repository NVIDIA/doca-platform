...
func (m *mockRPCClient) FsdevNfsCreate(name string, volumePath string, server string) error {
	if m.createErr != nil {
		return m.createErr
	}
...
func (m *mockRPCClient) FsdevNfsDelete(name string) error {
	if m.deleteErr != nil {
		return m.deleteErr
	}
