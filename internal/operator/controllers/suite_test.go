...
func TestMain(m *testing.M) {
	...
	// This file is generated by 'make generate-manifests-release-defaults'
	defaultsFile := filepath.Join("..", "..", "release", "manifests", "defaults.yaml")
	defaultsContent, err := os.ReadFile(defaultsFile)
	if err != nil {
		panic(fmt.Sprintf("Failed to read defaults file (run 'make generate-manifests-release-defaults'): %v", err))
	}
