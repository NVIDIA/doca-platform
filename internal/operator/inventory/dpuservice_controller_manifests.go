...
func (d *dpuServiceControllerObjects) IsReady(ctx context.Context, c client.Client, namespace string) error {
	return deploymentReadyCheck(ctx, c, namespace, d.objects, false)
}

// IsReadyAndVersionUpdated reports the readiness of the dpuservice controller objects as well as the version state.
// It returns an error when the number of Replicas in the single provisioning controller deployment is true.
func (d *dpuServiceControllerObjects) IsReadyAndVersionUpdated(ctx context.Context, c client.Client, namespace string) error {
