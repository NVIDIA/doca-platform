...
func (p *dpuDetectorObjects) IsReady(ctx context.Context, c client.Client, namespace string) error {
	return daemonSetReadyCheck(ctx, c, namespace, p.objects, false)
}

// IsReadyAndVersionUpdated reports the readiness of the dpu detector objects as well as the version state.
// It returns an error when the number of Replicas in the single dpu detector daemonset is true.
func (p *dpuDetectorObjects) IsReadyAndVersionUpdated(ctx context.Context, c client.Client, namespace string) error {
