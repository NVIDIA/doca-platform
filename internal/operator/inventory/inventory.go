...
type Component interface {
	...
	// IsReadyAndVersionUpdated checks if the component is ready and its version is updated.
	IsReadyAndVersionUpdated(ctx context.Context, c client.Client, namespace string) error
}
