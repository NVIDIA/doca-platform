...
// +kubebuilder:webhook:path=/mutate-provisioning-dpu-nvidia-com-v1alpha1-dpuflavor,mutating=true,failurePolicy=fail,sideEffects=None,groups=provisioning.dpu.nvidia.com,resources=dpuflavors,verbs=create,versions=v1alpha1,name=mdpuflavor.kb.io,admissionReviewVersions=v1
