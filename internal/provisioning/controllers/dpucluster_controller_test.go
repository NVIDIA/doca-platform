...
var _ = Describe("DPUCluster", func() {
	...
	const (
		DefaultNode = "dpf-provisioning-dpucluster-controller-node-test"
	)
	...
	BeforeEach(func() {
		...
		testNS = &corev1.Namespace{ObjectMeta: metav1.ObjectMeta{GenerateName: "dpucluster-controller-test"}}
