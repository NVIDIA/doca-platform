...
func Test_dpfctlTreeDiscovery(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedPrefix: []string{
				"DPFOperatorConfig/test  default  Ready: False  SomethingWentWrong",
			},
		},
		{
			name: "Add DPUCluster",
		...
		},
		{
			...
			expectedPrefix: []string{
				...
				"└─DPUSets",
				"  └─DPUSet/test         default",
				"    └─BFB/test          default  Ready: True  Ready    [0-9]+s  File: bf-bundle-2.9.1-50.bfb, DOCA: 2.9.1",
			},
		},
		{
			name: "Add DPU",
		...
		},
		{
			...
			expectedPrefix: []string{
				...
				"├─DPUServices",
				"│ └─DPUService/test                                  default  Ready: True  Success",
				"│   └─Application/test                               default  Ready: True  Success",
				"├─DPUSets",
				"│ └─DPUSet/test                                      default",
				"│   └─DPU/test                                       default  Ready: True  Success",
				"└─DPUs",
...
func defaultDPU() *provisioningv1.DPU {
	return &provisioningv1.DPU{
		ObjectMeta: metav1.ObjectMeta{Name: "orphaned-dpu", Namespace: "default"}, Spec: provisioningv1.DPUSpec{DPUDeviceName: "dpudevice-dpfctl-test"},
	}
}
...
func defaultDPUFromDPUSet() *provisioningv1.DPU {
	return &provisioningv1.DPU{
		...
		Spec: provisioningv1.DPUSpec{DPUDeviceName: "dpudevice-dpfctl-test"},
	}
}
