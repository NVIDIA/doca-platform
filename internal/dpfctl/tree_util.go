...
// GetConditions returns the other conditions (all the conditions except ready) for an object, if defined.
...
// HasConditions returns true if the object has conditions to show.
func HasConditions(obj client.Object) bool {
	return IsShowConditionsObject(obj) && len(GetConditions(obj)) > 0
}
