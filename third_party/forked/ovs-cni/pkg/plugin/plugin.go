...
func CmdAdd(args *skel.CmdArgs) error {
	...
	if err = attachIfaceToBridge(ovsDriver, hostIface.Name, contIface, netconf.OfportRequest, vlanTagNum, trunks, portType, netconf.InterfaceType, netconf.MTU, args.Netns, ovnPort, dpfId); err != nil {
		return err
	}
	defer func() {
		if err != nil {
