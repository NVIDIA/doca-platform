...
type StorageV1alpha1Interface interface {
	...
	SVVolumeAttachmentsGetter
}

// StorageV1alpha1Client is used to interact with features provided by the storage group.
type StorageV1alpha1Client struct {
	restClient rest.Interface
}

func (c *StorageV1alpha1Client) SVVolumeAttachments(namespace string) SVVolumeAttachmentInterface {
	return newSVVolumeAttachments(c, namespace)
}
